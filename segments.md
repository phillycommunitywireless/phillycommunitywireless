...
Then, you can create a new "partner card" on the Partners page (located in `content/en/about/partners.md` or `content/es/about/partners.md`) by adding a new entry to the yaml "sections" list of the `partner-card-container` partial
...
Then, you can create a new "funder card" on the Funders page (located in `content/en/about/funders.md` or `content/es/about/funders.md`) by adding a new entry to the yaml "sections" list of the `funder-card-container` partial
