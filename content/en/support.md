...
segments:
    ...
    - template: call-to-action-photo-right
      ...
      photo_alt_text: "A white rectangular access point device pointing down from high up towards blocks of rowhomes."
      button:
