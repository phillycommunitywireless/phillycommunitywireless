...
## Dispositivos asequibles: PCs for People
**Descripción**: Proporciona computadoras reacondicionadas a clientes que cumplan los requisitos a precios asequibles. Para realizar un pedido, necesitará una identificación con fotografía y documentación que acredite su inscripción actual en un programa de asistencia gubernamental basado en los ingresos O documentación que acredite los ingresos actuales de su hogar (por debajo del 200 % del umbral federal de pobreza o por debajo del 60 % de la renta media de la zona).  
**Compras en línea**: [Compre aquí](https://pcsrefurbished.com/sales/salesHome).  
**Contacto**: Llama al 215-621-8118 o envíe un correo electrónico a philadelphia@pcsforpeople.org.  

## Capacitación en habilidades digitales e inglés: The Welcoming Center (multilingües)
